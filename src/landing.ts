...
<body>
  <main>
    ...
    <section>
      ...
      <p class="muted">
        Pipeline: Firecrawl scrape &rarr; Workers AI Llama-3.3-70b structured extraction &rarr; per-topic <code>pm_discover</code> fan-out &rarr; rank by stance alignment, liquidity, settlement risk. Stateless. No URL or extracted content is persisted.
      </p>
